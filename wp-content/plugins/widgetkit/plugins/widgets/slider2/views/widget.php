        ...
        <?php foreach ($items as $item) :
            ...
            <li>
                ...
                <div class="{wk}-panel {wk}-overlay {wk}-overlay-hover {wk}-cover-background" <?php echo $media; ?>>
                        ...
                        <div>
                            ...
                            <h3 class="<?php echo $title_size; ?> {wk}-margin-top-remove">
                                ...
                                <?php if ($item['link'] && $settings['panel_link']) : ?>
                                    <a class="uk-position-cover uk-position-z-index" title="<?php echo htmlspecialchars($item['title']);?>" data-lightbox-type="image" data-uk-lightbox="{group:'<?php echo $groupcode;?>'}" href="<?php echo $item->get('media'); ?>"<?php echo $link_target; ?>></a>                                <?php else : ?>
                                    <?php echo $item['title']; ?>
                                <?php endif; ?>
                    ...
                    <a class="{wk}-position-cover" href="<?php echo $item->escape('link'); ?>" data-lightbox-type="image" data-uk-lightbox="{group:\''.$groupcode.'\'}" <?php echo $link_target; ?>></a>
                    <?php endif; ?>
