...
return array(
    ...
    'config' => array(
        ...
        'label' => 'Slider2',
        'core'  => true,
        'icon'  => 'plugins/widgets/slider2/widget.svg',
        'view'  => 'plugins/widgets/slider2/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('slider2.edit', 'plugins/widgets/slider2/views/edit.php', true);
        }
