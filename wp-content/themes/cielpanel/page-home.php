...
<?php echo do_shortcode('[widgetkit id="23"]'); ?>

<div class="sliders">
<div class="sliders1"><?php echo do_shortcode('[widgetkit id="24"]'); ?></div>
<div class="sliders2"><?php echo do_shortcode('[widgetkit id="25"]'); ?></div>
<div class="sliders3"><?php echo do_shortcode('[widgetkit id="26"]'); ?></div>
<div class="sliders4"><?php echo do_shortcode('[widgetkit id="27"]'); ?></div>
<div class="sliders5"><?php echo do_shortcode('[widgetkit id="28"]'); ?></div>
</div>
<!-- bajada -->
...
<div class="llamada">
<div class="texto"><h3>More than <strong>500</strong> projects</h3></div>
<div class="boton"><a href="http://cielpanel.com/it/contacto/">Contact US Now!</a></div>
</div>
